!function (t, e) {
    ...
    l.prototype = {
        constructor: l, _process_options: function (s) {
            ...
            if (n.defaultViewDate) {
                var c = n.defaultViewDate.year || (new Date).getFullYear(), u = n.defaultViewDate.month || 0, f = n.defaultViewDate.day || 1;
            ...
            this.o.showOnFocus === !0 && (e.focus = t.proxy(this.show, this)), this.isInput ? this._events = [[this.element, e]] : this.component && this.hasInput ? this._events = [[this.element.find("input"), e], [this.component, {click: t.proxy(this.show, this)}]] : this.element.is("div") ? this.isInline = !0 : this._events = [[this.element, {click: t.proxy(this.show, this)}]], this._events.push([this.element, "*", {
                ...
                mousedown: t.proxy(function (t) {
                    this.element.is(t.target) || this.element.find(t.target).length || this.picker.is(t.target) || this.picker.find(t.target).length
                }, this)
            }]]
            ...
            var e = this.picker.outerWidth(), a = this.picker.outerHeight(), i = 10, s = t(this.o.container).width(), n = t(this.o.container).height(), r = t(this.o.container).scrollTop(), o = t(this.o.container).offset(), h = [];
            this.element.parents().each(function () {
                var e = t(this).css("z-index");
                "auto" !== e && 0 !== e && h.push(parseInt(e))
            });
            var l = Math.max.apply(Math, h) + 10, d = this.component ? this.component.parent().offset() : this.element.offset(), c = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1), u = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1), p = d.left - o.left, f = d.top - o.top;
            ...
            var i, s = new Date(this.viewDate), n = s.getUTCFullYear(), r = s.getUTCMonth(), o = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0, h = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0, l = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCFullYear() : 1 / 0, d = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCMonth() : 1 / 0, c = g[this.o.language].today || g.en.today || "", u = g[this.o.language].clear || g.en.clear || "";
            if (!isNaN(n) && !isNaN(r)) {
                ...
                var p = a(n, r - 1, 28), f = D.getDaysInMonth(p.getUTCFullYear(), p.getUTCMonth());
                ...
                for (var m, y = []; p.valueOf() < v;) {
                    if (p.getUTCDay() === this.o.weekStart && (y.push("<tr>"), this.o.calendarWeeks)) {
                        var w = new Date(+p + (this.o.weekStart - p.getUTCDay() - 7) % 7 * 864e5), k = new Date(Number(w) + (11 - w.getUTCDay()) % 7 * 864e5), C = new Date(Number(C = a(k.getUTCFullYear(), 0, 1)) + (11 - C.getUTCDay()) % 7 * 864e5), b = (k - C) / 864e5 / 7 + 1;
                    ...
                    if (m = this.getClassNames(p), m.push("day"), this.o.beforeShowDay !== t.noop) {
                        ...
                        T === e ? T = {} : "boolean" == typeof T ? T = {enabled: T} : "string" == typeof T && (T = {classes: T}), T.enabled === !1 && m.push("disabled"), T.classes && (m = m.concat(T.classes.split(/\s+/))), T.tooltip && (i = T.tooltip)
                    }
                ...
                n -= 1;
                for (var x, F = t.map(this.dates, function (t) {
                    return t.getUTCFullYear()
                }), S = -1; 11 > S; S++)x = ["year"], -1 === S ? x.push("old") : 10 === S && x.push("new"), -1 !== t.inArray(n, F) && x.push("active"), (o > n || n > l) && x.push("disabled"), y += '<span class="' + x.join(" ") + '">' + n + "</span>", n += 1;
                M.html(y)
            }
            ...
            if (this._allow_update) {
                ...
                switch (this.viewMode) {
                    case 0:
                        this.picker.find(".prev").css(this.o.startDate !== -1 / 0 && e <= this.o.startDate.getUTCFullYear() && a <= this.o.startDate.getUTCMonth() ? {visibility: "hidden"} : {visibility: "visible"}), this.picker.find(".next").css(1 / 0 !== this.o.endDate && e >= this.o.endDate.getUTCFullYear() && a >= this.o.endDate.getUTCMonth() ? {visibility: "hidden"} : {visibility: "visible"});
                        break;
                    case 1:
                    case 2:
            ...
            if (!t)return e;
            if (!a)return t;
            var i, s, n = new Date(t.valueOf()), r = n.getUTCDate(), o = n.getUTCMonth(), h = Math.abs(a);
            if (a = a > 0 ? 1 : -1, 1 === h)s = -1 === a ? function () {
                return n.getUTCMonth() === o
            } : function () {
                return n.getUTCMonth() !== i
            }, i = o + a, n.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12); else {
    ...
    var d = function (e, a) {
        ...
        }), delete a.inputs, u.call(t(this.inputs), a).on("changeDate", t.proxy(this.dateUpdated, this)), this.pickers = t.map(this.inputs, function (e) {
    ...
    d.prototype = {
        updateDates: function () {
            ...
            if (!this.updating) {
                this.updating = !0;
                var a = t(e.target).data("datepicker"), i = a.getUTCDate(), s = t.inArray(e.target, this.inputs), n = s - 1, r = s + 1, o = this.inputs.length;
                if (-1 !== s) {
    ...
    var c = t.fn.datepicker, u = function (a) {
        var i = Array.apply(null, arguments);
        i.shift();
        var s;
        return this.each(function () {
            var n = t(this), h = n.data("datepicker"), c = "object" == typeof a && a;
            if (!h) {
                var u = r(this, "date"), f = t.extend({}, p, u, c), g = o(f.language), D = t.extend({}, p, g, u, c);
                if (n.hasClass("input-daterange") || D.inputs) {
                    var v = {inputs: D.inputs || n.find("input").toArray()};
    ...
    var g = t.fn.datepicker.dates = {
        ...
        parseDate: function (i, s, n) {
            function r() {
                var t = this.slice(0, u[d].length), e = u[d].slice(0, t.length);
            ...
            var o, h, d, c = /([\-+]\d+)([dmwy])/, u = i.match(/([\-+]\d+)([dmwy])/g);
            ...
            if (u.length !== w.length && (w = t(w).filter(function (e, a) {
                ...
                var C, b;
                for (d = 0; d < m.length; d++)b = m[d], b in v && !isNaN(v[b]) && (C = new Date(i), y[b](C, v[b]), isNaN(C) || (i = C))
            }
            return i
        },
